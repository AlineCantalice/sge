...
public abstract class ConstrutorDeEntidade<E> {
    ...
    private com.sge.sge.builder.CustomizacaoEntidade<E> customizacao;
     ...
     */
    public ConstrutorDeEntidade<E> customizar(com.sge.sge.builder.CustomizacaoEntidade<E> customizacao) {
     ...
     */
    public void setCustomizacao(com.sge.sge.builder.CustomizacaoEntidade<E> customizacao) {
        this.customizacao = customizacao;
    }
}